    ...
    <div class="container mx-auto px-6 z-20">
        <div class="max-w-4xl mx-auto text-center px-4 py-16 md:py-24 lg:py-32">
            ...
            <div class="flex flex-col sm:flex-row justify-center gap-4 mt-12" data-aos="fade-up" data-aos-delay="300">
                <a href="#projects"
                    class="px-8 py-3.5 bg-gradient-to-r from-pink-800 to-[#1A132F] hover:from-[#1A132F] hover:to-pink-800 text-white font-medium rounded-full transition-all duration-300 transform hover:scale-105 shadow-lg shadow-pink-500/30 focus:outline-none focus:ring-2 focus:ring-pink-300 focus:ring-offset-2">
                    ✨ View Portfolio
                </a>
                <a href="#contact"
 ...
 <section id="about" class="relative bg-[#1a132f] py-20 px-6 md:px-12 lg:px-24 font-serif overflow-hidden">
    ...
    <div class="relative z-20 max-w-6xl mx-auto">
        ...
        <div class="grid md:grid-cols-3 gap-8">
            <!-- Skill Card 1 -->
            <div class="bg-white/10 border border-pink-900/40 p-6 rounded-2xl shadow-lg backdrop-blur-sm transition-all duration-300 hover:scale-105 hover:shadow-pink-400/20"
...
<section id="skills" class="relative overflow-hidden min-h-screen py-20 bg-[#1a132f] font-serif">
  ...
  <div class="relative z-10 container mx-auto px-6 md:px-12 lg:px-24">
    ...
    <div class="mt-20 bg-white/5 border border-white/10 rounded-2xl p-8 shadow-lg shadow-pink-500/10" data-aos="fade-up" data-aos-delay="200">
      ...
      <div class="space-y-6">
        <div>
          <div class="flex justify-between mb-2">
            ...
            <span class="text-pink-300">95%</span>
          </div>
          <div class="w-full bg-gray-800 rounded-full h-3">
            <div class="bg-gradient-to-r from-pink-300 via-pink-300 to-pink-400 h-3 rounded-full" style="width: 95%"></div>
          </div>
        </div>
        <div>
          <div class="flex justify-between mb-2">
            <span class="text-white font-medium">Tailwindcss </span>
            <span class="text-pink-300">90%</span>
          </div>
          <div class="w-full bg-gray-800 rounded-full h-3">
            <div class="bg-gradient-to-r from-pink-300 to-pink-400 h-3 rounded-full" style="width: 90%"></div>
          </div>
        </div>
        <div>
          <div class="flex justify-between mb-2">
            <span class="text-white font-medium">JavaScript / Laravel</span>
            <span class="text-pink-300">85%</span>
          </div>
          <div class="w-full bg-gray-800 rounded-full h-3">
            <div class="bg-gradient-to-r from-pink-400 to-pink-700 h-3 rounded-full" style="width: 85%"></div>
          </div>
        </div>
        <div>
          <div class="flex justify-between mb-2">
    ...
    <section id="projects" class="relative py-16 px-4 sm:px-8 lg:px-24 overflow-hidden bg-gray-950">
        ...
        <div class="absolute inset-0 z-0 overflow-hidden">
            ...
            <div class="absolute inset-0 bg-gradient-to-b from-pink-900/10 to-gray-950/90"></div>
        </div>
            ...
            <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                ...
                <div class="bg-black/90 backdrop-blur-sm rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="p-6">
                        ...
                        <div class="flex flex-wrap gap-2">
                            <span class="px-2 py-1 bg-pink-100 text-pink-800 text-xs font-medium rounded">Next.js</span>
                            <span class="px-2 py-1 bg-pink-100 text-pink-800 text-xs font-medium rounded">Stripe</span>
                            <span class="px-2 py-1 bg-pink-100 text-pink-800 text-xs font-medium rounded">MongoDB</span>
                        </div>
                        <div class="flex space-x-4 mt-4">
                            <a href="#"
                                class="flex-1 px-4 py-2 bg-pink-600 text-white text-sm font-medium rounded-lg hover:bg-pink-700 transition flex items-center justify-center gap-1">
    ...
    <section id="cta" class="relative py-16 bg-gray-900 overflow-hidden">
        <div class="absolute inset-0 bg-gradient-to-b from-pink-500/10 to-gray-900/80"></div>
                ...
                <div class="space-y-8" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="bg-white/10 backdrop-blur-sm border border-gray-800 rounded-2xl p-8">
                        ...
                        <div class="flex space-x-4">
                            ...
                            <a href="#" class="w-12 h-12 bg-gray-800 rounded-full flex items-center justify-center hover:bg-pink-400 transition">
                                <svg class="h-6 w-6 text-white" fill="currentColor" viewBox="0 0 24 24">
