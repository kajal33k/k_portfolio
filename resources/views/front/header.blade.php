    ...
    <!-- Navbar -->
    <nav
        class="bg-black opacity-40 top-0 left-0 w-full z-50 text-white  shadow border-b border-gray-200 dark:border-gray-700">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="hidden md:flex space-x-6 items-center">
                    ...
                    <!-- CTA Button -->
                    <a href="#hire-me"
                        class="bg-teal-600 hover:bg-teal-700 text-white px-4 py-2 rounded-md font-medium">Hire Me</a>
                </div>
        ...
        <div id="mobile-menu" class="md:hidden hidden px-4 pt-4 pb-6 space-y-2 bg-white dark:bg-gray-900">
            ...
            <a href="#hire-me" class="block bg-teal-600 hover:bg-teal-700 text-white text-center py-2 rounded-md">Hire
                Me</a>
